...
async function getSocialLinks() {
  try {
    ...
    if (error) return {};
    return Object.fromEntries((data || []).map((row) => [row.platform, row.url]));
  } catch {
    return {};
  }
}
        ...
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              ...
              <li><Link className="hover:text-primary transition-colors" href="/meta-ads">Ads Expert</Link></li>
              <li><Link className="hover:text-primary transition-colors" href="/wordpress-dev">Web Design</Link></li>
