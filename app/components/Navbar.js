    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 glass-nav">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-12 font-light tracking-wide">
            <Link className="text-xs uppercase tracking-widest text-[#EDEDED] border-b border-[#C6A75E] pb-1" href="/">Home</Link>
            <Link className="text-xs uppercase tracking-widest text-[#888888] hover:text-[#EDEDED] transition-colors" href="/#about-hero">About</Link>
          ...
          <div className="flex items-center gap-4">
            <Link href="/#contact" className="hidden sm:flex items-center justify-center border border-[#C6A75E] text-[#EDEDED] hover:bg-[#C6A75E]/5 transition-colors font-medium text-xs tracking-widest uppercase px-6 py-2 h-10 rounded">
              Hire Me
            </Link>
            <button
      ...
      >
        <div className="flex flex-col gap-8 text-xl font-light tracking-wide">
          ...
          <Link onClick={() => setMenuOpen(false)} className="text-[#888888] hover:text-[#EDEDED] transition-colors pb-2 border-b border-white/5 uppercase text-sm tracking-widest" href="/#about-hero">About</Link>
