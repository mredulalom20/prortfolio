  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background-dark text-slate-100">
        ...
        <section className="py-14" id="contact"><div className="mx-auto max-w-7xl px-6"><div className="grid grid-cols-1 gap-16 lg:grid-cols-2"><div><h2 className="mb-3 text-sm font-bold uppercase tracking-widest text-primary">Get in touch</h2><h3 className="mb-8 text-5xl font-black text-white">Let&apos;s build something great.</h3><p className="mb-12 max-w-md text-lg leading-relaxed text-muted">Ready to scale your business or start a new creative project? Reach out and let&apos;s discuss how I can help you achieve your goals.</p><div className="space-y-8"><div className="flex items-center gap-6"><div className="flex size-14 items-center justify-center rounded-xl border border-white/5 bg-surface text-primary"><span className="material-symbols-outlined">mail</span></div><div><p className="mb-1 text-xs font-bold uppercase tracking-widest text-muted">Email</p><p className="text-lg font-bold text-white">contact@mhrinku.com</p></div></div><div className="flex items-center gap-6"><div className="flex size-14 items-center justify-center rounded-xl border border-white/5 bg-surface text-primary"><span className="material-symbols-outlined">location_on</span></div><div><p className="mb-1 text-xs font-bold uppercase tracking-widest text-muted">Location</p><p className="text-lg font-bold text-white">Dhaka, Bangladesh</p></div></div></div></div><div className="rounded-2xl border border-white/5 bg-surface p-10 shadow-2xl"><ContactForm /></div></div></div></section>
      </main>
      <Footer />
    </>
  );
