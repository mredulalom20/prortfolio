# Graph Report - mobarok-portfolio  (2026-05-24)

## Corpus Check
- 60 files · ~204,080 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 158 nodes · 160 edges · 8 communities detected
...
- `PATCH()` --calls--> `UPLOAD_DIR()`  [EXTRACTED]
  app\api\team\route.js → app\api\media\trash\route.js
...
- **Thin community `Community 13`** (3 nodes): `route.js`, `POST()`, `sanitizeFilename()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (3 nodes): `page.js`, `BlogPage()`, `getBlogs()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
